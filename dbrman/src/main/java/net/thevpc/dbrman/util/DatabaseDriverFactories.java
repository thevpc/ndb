...
import net.thevpc.dbrman.impl.JtdsSqlServerDatabaseDriver;
import net.thevpc.dbrman.impl.PostgreSqlDatabaseDriver;
import net.thevpc.dbrman.impl.SqlServerDatabaseDriver;
...
//                        }
    ...
    public static DatabaseDriver createDatabaseDriver(String url, String login, String pwd, DbType dbType) {
        try {
            System.out.println("createDatabaseDriver:" + url + "  ::: " + login + " / " + pwd + " / " + dbType);
