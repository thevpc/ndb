        ...
        while (cmdLine.hasNext()) {
            if (cmdLine.isNextOption()) {
                ...
                switch (key) {
                    ...
                    case "--to-ssh":
                    case "--to-db": {
                        cmdLine.matcher().whenAny().asEntry((v) -> toOptions.addAll(Arrays.asList(
                                "--" + key.substring("--to-".length())
                                , v.stringValue()))).require();
                        break;
                    }
                    case "--file": {
                        cmdLine.matcher().whenAny().asEntry((vv) -> {
                    ...
                    case "--keep-file": {
                        cmdLine.matcher().whenAny().asFlag((v) -> keepFile.set(v.booleanValue())).anyMatch();
                        break;
                    }
                    default: {
