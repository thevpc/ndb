        ...
        while (cmdLine.hasNext()) {
            if (cmdLine.isNextOption()) {
                ...
                switch (key) {
                    ...
                    case "--to-ssh":
                    case "--to-db": {
                        cmdLine.matcher().withAny().matchEntry((v) -> toOptions.addAll(Arrays.asList(
                                "--" + key.substring("--to-".length())
                                , v.stringValue()))).require();
                        break;
                    }
                    case "--file": {
                        cmdLine.matcher().withAny().matchEntry((vv) -> {
                    ...
                    case "--keep-file": {
                        cmdLine.matcher().withAny().matchFlag((v) -> keepFile.set(v.booleanValue())).anyMatch();
                        break;
                    }
                    default: {
