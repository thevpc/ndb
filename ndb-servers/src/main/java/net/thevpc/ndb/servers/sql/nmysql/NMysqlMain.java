...
import net.thevpc.ndb.servers.sql.nmysql.remote.RemoteMysqlDatabaseConfigService;
    ...
    private void runPushOrPull(NCmdLine cmdLine, boolean pull, NMySqlService service) {
        ...
        while (cmdLine.hasNext()) {
            if (cmdLine.isNextOption()) {
                ...
                if (d.name == null) {
                    d.name = new AtName(cmdLine.next().get().image());
                } else if (d.path == null) {
                    d.path = cmdLine.next().get().image();
                } else {
        ...
        while (cmdLine.hasNext()) {
            if (cmdLine.isNextOption()) {
                ...
                if (name.isNull()) {
                    ...
                    sql.add(cmdLine.next().get().image());
                }
            }
        }
        if (name.isNull()) {
        ...
        while (cmdLine.hasNext()) {
            if (cmdLine.isNextOption()) {
                ...
                if (name.isNull()) {
                    ...
                    path.set(cmdLine.next().get().image());
                } else {
                    cmdLine.throwUnexpectedArgument();
                }
            }
