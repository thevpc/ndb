...
public class TableRestoreOptions {
    ...
    public NSqlPatchTableOptions toSqlPatchTableOptions(){
        return new NSqlPatchTableOptions()
                .setCreateColumn(isCreateColumn())
                .setDropColumn(isDropColumn())
                .setDropTable(isDropTable());
    }
}
