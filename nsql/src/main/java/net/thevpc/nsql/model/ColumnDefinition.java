...
//    }
//
//    public ColumnDefinition setColumnType(SqlColumnType columnType) {
...
//    }
//
//    public ColumnDefinition setGeneratedColumn(YesNo generatedColumn) {
...
//        return new ColumnIdAsStoreFieldId(getColumnId());
//    }
//
...
//        return index == that.index && precision == that.precision && scale == that.scale && sqlType == that.sqlType && displaySize == that.displaySize && radix == that.radix && sourceDataType == that.sourceDataType && pkIndex == that.pkIndex && pk == that.pk && fk == that.fk && Objects.equals(columnName, that.columnName) && Objects.equals(label, that.label) && Objects.equals(javaClassName, that.javaClassName) && Objects.equals(sqlTypeCode, that.sqlTypeCode) && nullable == that.nullable && Objects.equals(columnDef, that.columnDef) && Objects.equals(sqlTypeName, that.sqlTypeName) && Objects.equals(schemaName, that.schemaName) && Objects.equals(catalogName, that.catalogName) && Objects.equals(tableName, that.tableName) && Objects.equals(sourceDataTypeCode, that.sourceDataTypeCode) && autoIncrement == that.autoIncrement && generatedColumn == that.generatedColumn && storeType == that.storeType;
//    }
//
//    @Override
//    public int hashCode() {
//        return Objects.hash(index, columnName, label, javaClassName, precision, scale, sqlType, sqlTypeCode, displaySize, radix, nullable, columnDef, sqlTypeName, schemaName, catalogName, tableName, sourceDataType, sourceDataTypeCode, autoIncrement, generatedColumn, storeType, pkIndex, pk, fk);
//    }
//
//    @Override
