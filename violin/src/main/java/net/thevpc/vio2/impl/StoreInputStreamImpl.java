...
import net.thevpc.vio2.api.ObjectReader;
 ...
 * @author vpc
 */
public class StoreInputStreamImpl implements StoreInputStream {

    private DataInputStream dis;
    Sers srs;

    public StoreInputStreamImpl(InputStream in, Sers srs) {
